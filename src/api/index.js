...
import { deliverySlotRoute } from './resources/Settings/DeliverySlotSettings';
...
import {inStockRoute} from"./resources/inventoryStockSetting";
import {adminContactRoute} from"./resources/adminContactUs";
import {giftoffersRoute} from"./resources/Marketing&Permotion/GiftOffers"
...
restRouter.use('/inStockRoute',inStockRoute)
...
restRouter.use('/deliveryslot',deliverySlotRoute)
restRouter.use('/adminContact',adminContactRoute)
restRouter.use('/giftoffers',giftoffersRoute)
